            ...
            ScrollView(.vertical){
                VStack{
                    ...
                    Group{
                        ...
                        Text("では自律的な行動とはどのようなものでしょうか。anomでは自己決定理論に基づいて、興味関心などのポジティブな感情による行動、本人が重要だと認識して受け入れている行動を自律的な行動と捉えています。").font(.body)
                    ...
                    Group{
                        ...
                        Text("なにをやるかは重要ではありません。自分のやりたいことを自分でやると決めて、実際にやることが大切です。").font(.body)
                        ...
                        Text("anomを使うことで自律的な行動を意識してみましょう。").font(.body)
                    ...
                    Group{
                        ...
                        Text("やりたいことと合わせて気分も記録することで、自分がどんなことをやった日に気分が良かったのか内省するヒントになれば幸いです。").font(.body)
                    }.padding(15)
